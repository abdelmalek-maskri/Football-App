...
class CommentResourceIT {
    ...
    public static Comment createEntity(EntityManager em) {
        Comment comment = new Comment().rating(DEFAULT_RATING).content(DEFAULT_CONTENT).likeCount(DEFAULT_LIKE_COUNT);
        return comment;
    }
    ...
    public static Comment createUpdatedEntity(EntityManager em) {
        Comment comment = new Comment().rating(UPDATED_RATING).content(UPDATED_CONTENT).likeCount(UPDATED_LIKE_COUNT);
        return comment;
    }
    ...
    void createComment() throws Exception {
        ...
        assertThat(testComment.getLikeCount()).isEqualTo(DEFAULT_LIKE_COUNT);
    }
    ...
    void putExistingComment() throws Exception {
        ...
        updatedComment.rating(UPDATED_RATING).content(UPDATED_CONTENT).likeCount(UPDATED_LIKE_COUNT);
        ...
        assertThat(testComment.getLikeCount()).isEqualTo(UPDATED_LIKE_COUNT);
    }
    ...
    void partialUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.rating(UPDATED_RATING).likeCount(UPDATED_LIKE_COUNT);
    ...
    void fullUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.rating(UPDATED_RATING).content(UPDATED_CONTENT).likeCount(UPDATED_LIKE_COUNT);
