...
describe('Team Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call owner query and add missing value', () => {
      ...
      const owner: IUserProfile = { id: 41976 };
      team.owner = owner;

      const ownerCollection: IUserProfile[] = [{ id: 94694 }];
      jest.spyOn(userProfileService, 'query').mockReturnValue(of(new HttpResponse({ body: ownerCollection })));
      const expectedCollection: IUserProfile[] = [owner, ...ownerCollection];
      ...
      expect(userProfileService.addUserProfileToCollectionIfMissing).toHaveBeenCalledWith(ownerCollection, owner);
      expect(comp.ownersCollection).toEqual(expectedCollection);
    });

    it('Should update editForm', () => {
      const team: ITeam = { id: 456 };
      const owner: IUserProfile = { id: 93609 };
      team.owner = owner;
